...
This project is indexed by GitNexus as **wechat_rails** (5903 symbols, 10080 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
