...
This project is indexed by GitNexus as **wechat_rails** (5847 symbols, 9977 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
